...
const Products = () => {
  return (
    <div className='app__products ' id='products'>
      ...
      <img src={images.i2} alt="Cà phê Robusta" className="mobile-img-2 product-img img2"/>
      <div className='app__products-content'>
          <p className="product-name p__opensans">Cà phê Robusta </p>
          <p className = "about-text t2 ">
      ...
      <div className='app__products-intro2  section__padding '>
        ...
        <p className="product-name p__opensans">Cà phê Arabica</p>
          <p className = "about-text t3 ">
          ...
          <img src={images.i4} alt="Cà phê Arabica" className="mobile-img-3 product-img img3"/>
      </div>

      <div className='app__products-intro3  section__padding '>
      <img src={images.i3} alt="Cà phê Liberia" className="mobile-img-4 product-img img4"/>
        <div className='app__products-content'>
        <p className=" product-name p__opensans heading4">Cà phê Liberia</p>
          <p className = "about-text t4 ">
